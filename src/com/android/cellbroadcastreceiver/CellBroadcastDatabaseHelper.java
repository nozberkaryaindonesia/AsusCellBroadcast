...
public class CellBroadcastDatabaseHelper extends SQLiteOpenHelper {
    ...
    //For Intel DSDS devices
    protected static final String SIM_ID = "sim_id";
     ...
     * Database version 12: adds Intel DSDS SIM_ID columns
     */
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + TABLE_NAME + " ("
                ...
                + Telephony.CellBroadcasts.SUBSCRIPTION_ID + " LONG,"
                ...
                + SIM_ID + " INTEGER DEFAULT 0);"); // dion_yang@20131202:Add intel DSDS column
    ...
    // +++ dion_yang@20131202:Add intel DSDS column
    private void createSimIdColumn(SQLiteDatabase db) {
        // Add 'sim_id' column to broadcasts table.
        db.execSQL("ALTER TABLE " + TABLE_NAME + " ADD COLUMN " + SIM_ID +
                " INTEGER DEFAULT 0");
    }
    // --- dion_yang@20131202:Add intel DSDS column
...
,
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        // +++ dion_yang@20131202:Add intel DSDS column
        if(oldVersion == 11) {
            Log.d(TAG,"createSimIdColumn");
            createSimIdColumn(db);
            oldVersion++;
        }
        // --- dion_yang@20131202:Add intel DSDS column
    }
