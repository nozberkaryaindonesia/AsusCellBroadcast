...
public class GsmUmtsCellBroadcastSmsFragment extends GsmUmtsCellBroadcastSmsFragmentBase {
    private static final String TAG = "GsmUmtsCellBroadcastSmsFragment";

    // These may be referred by BroadcastConfigInstantiatorService
    public static final String PREF_CATEGORY_ALERTSETTINGS = "emergency_alert_settings";
    public static final String PREF_CATEGORY_CUSTOMSETTINGS = "custom_setting";
    public static final String PREF_KEY_PRESIDENTIALALERTS = "preference_key_presidential_alerts_for_sim1";
    public static final String PREF_KEY_ALLALERTS = "preference_key_all_alerts_for_sim1";
    public static final String PREF_KEY_EXTREMEALERTS = "preference_key_extreme_alerts_for_sim1";
    public static final String PREF_KEY_SEVEREALERTS = "preference_key_severe_alerts_for_sim1";
    public static final String PREF_KEY_AMBERALERTS = "preference_key_amber_alerts_for_sim1";
    public static final String PREF_KEY_ENABLE_EMBERGENCYALERTS = "preference_key_enable_emergency_alerts_for_sim1";;
    public static final String PREF_KEY_ENABLE_ALERTVIBRATION = "preference_key_alert_vibration_setting_for_sim1";
    public static final String PREF_KEY_ENABLE_ETWSTESTALERTS = "preference_key_enable_etws_test_alerts_for_sim1";
    public static final String PREF_KEY_ENABLE_CMASTESTALERTS = "preference_key_enable_cmas_test_alerts_for_sim1";
    public static final String PREF_KEY_SMSCBLANGUAGE = "list_language";

    private static String sLanguageNow = "";//OliverOu@20160107: TT-722138

    public GsmUmtsCellBroadcastSmsFragment() {
        mSlotId = SLOTID_SLOT1;
    ...
    public boolean onContextItemSelected(MenuItem item) {
        if (SLOTID_SLOT1 != GsmUmtsCellBroadcastSmsDual.SELECED_SIM_TAB) return false;
