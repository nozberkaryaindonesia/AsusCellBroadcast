...
public class CellBroadcastListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cell_broadcast_list_activity);
        ...
        if (fm.findFragmentById(R.id.cell_broadcast_list_activity_fragment_container) == null) {
            CursorLoaderListFragment listFragment = new CursorLoaderListFragment();
            fm.beginTransaction()
                    .add(R.id.cell_broadcast_list_activity_fragment_container, listFragment)
                    .commit();
        }
    }
    ...
    public static class CursorLoaderListFragment extends ListFragment
        ...
        public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
            ...
            // +++ dion_yang@20130913:Remove setting menu item
            if(getResources().getBoolean(R.bool.show_setting_menuitem)) {
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
            ...
            // +++ dion_yang@20140102:fix ATT requirement
            ...
            switch(item.getItemId()) {
                ...
                case MENU_PREFERENCES:
                    ...
                    if (CellBroadcastUtils.isMultiSimEnabled() && !CellBroadcastUtils.isMultiSimDSDA()) {
                        intent = new Intent(getActivity(), GsmUmtsCellBroadcastSmsDual.class);
                    } else {
                        intent = new Intent(getActivity(), GsmUmtsCellBroadcastSms.class);
                    }
                    // --- dion_yang@20131026:For ATT requirement
